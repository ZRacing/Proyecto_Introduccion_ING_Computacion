...
{
	FILE* fp = nullptr;
	char buffer[300];   // Buffer temporal para leer las lineas
	iNumElementos = 0;  // Se inicializa un contador
...
void ListaCandidatas(
	...
	int& iNumLista)
{
	iNumLista = 0; //Se inIcializa el contador de elemnntos en 0 para evitar erorres
	...
	// Ordenar szListaFinal por peso (metodo burbuja)
